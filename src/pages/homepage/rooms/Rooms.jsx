                    ...
                    <div key={room.id} className={styles.container}>
                        ...
                        <div className={styles.content}>
                            ...
                            <div className={styles.roomFooter}>
                                ...
                                <Link to={"/roomDetails"}>
                                    <button  className={styles.roomButton}>Get Room Details</button>
                                </Link>
                            </div>
                        </div>
                    </div>
...
//             try {
//                 const response = await axios.get("http://api.fortunaehotel.com/api/v1/rooms/hotel/1", {
//                     headers: {
//                         "Content-Type": "application/json",
//                         Authorization: `Bearer ${token}`, // Store token securely
//                     },
//                 });
//                 setRoomList(response.data); // Assuming API returns an array of rooms
//             } catch (error) {
...
//                 <p className={styles.subTitle}>
//                     The elegant luxury bedrooms in this gallery showcase custom interior
//                     designs & decorating ideas. View pictures and find your perfect luxury bedroom design.
//                 </p>
//                 <img
//                     className={styles.image}
//                     src={Scroll}
